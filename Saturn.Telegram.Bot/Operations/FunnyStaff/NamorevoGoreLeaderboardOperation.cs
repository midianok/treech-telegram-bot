...
public class NamorevoGoreLeaderboardOperation(
    ...
    IDbContextFactory<SaturnContext> contextFactory) : IOperation
{
    ...
    public async Task OnMessageAsync(Message msg, UpdateType type)
    {
        ...
        var replyMessage = new StringBuilder("Топ игроков Наморево Горе:\n");
        var iterator = 1;
        ...
        var keyboard = new InlineKeyboardMarkup(
            InlineKeyboardButton.WithUrl("Играть", "https://t.me/TreechBot/namorevogore"));
