...
//             .ToListAsync();
//
//         var request = "Сделай саммари по следующим сообщениям из чата, ответь в формате Plain Text, полностью на русском языке. Структура: 1 строчка это одно сообщение в формате [дата_сообщения] пробел [имя_отправителя] пробел [сообщение]. Список сообщений в порядке их отправления:";
//
