...
namespace Saturn.Telegram.Db.Migrations
{
    ...
    [Migration("20260602152650_AddCoinBalanceAndTransactions")]
    partial class AddCoinBalanceAndTransactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saturn.Telegram.Db.Entities.CoinTransactionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ExternalPaymentId")
                        .IsUnique()
                        .HasDatabaseName("ix_coin_transactions_external_payment_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_coin_transactions_user_id");
