...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saturn.Telegram.Db.Entities.AccountEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "ChatId")
                        .IsUnique()
                        .HasDatabaseName("ix_account_entity_user_id_chat_id");

                    b.ToTable("account_entity", (string)null);
                });
            ...
            modelBuilder.Entity("Saturn.Telegram.Db.Entities.InvoiceEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_invoice_entity");

                    b.ToTable("invoice_entity", (string)null);
                });
            ...
            modelBuilder.Entity("Saturn.Telegram.Db.Entities.RulesEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_rules_entity");

                    b.ToTable("rules_entity", (string)null);
                });
